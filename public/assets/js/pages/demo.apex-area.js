...
$(document).ready(function () {
  ...
  var chart = new ApexCharts(document.querySelector("#area-chart-datetime"), options);
  chart.render();
...
var chart = new ApexCharts(document.querySelector("#area-chart-negative"), options);
chart.render(); //
...
var chartarea2 = new ApexCharts(document.querySelector("#area-chart-github2"), optionsarea2);
chartarea2.render();
var colors = ["#7BD39A"];
...
var chart = new ApexCharts(document.querySelector("#area-chart-github"), options);
chart.render(); //
// STACKED AREA
//
...
var chart = new ApexCharts(document.querySelector("#area-chart-nullvalues"), options);
chart.render();
/******/ })()
;