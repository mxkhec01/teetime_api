...
var chart = new ApexCharts(document.querySelector("#line-chart-datalabel"), options);
chart.render(); //
// Zoomable Timeseries
//
...
var chart = new ApexCharts(document.querySelector("#line-chart-annotations"), options);
chart.render(); //
// Syncing charts
//
...
var chartline2 = new ApexCharts(document.querySelector("#line-chart-syncing"), optionsline2);
chartline2.render(); // 
// Syncing Chart-2
//
...
var chart = new ApexCharts(document.querySelector("#line-chart-syncing2"), options);
chart.render();
/*
...
var chart = new ApexCharts(document.querySelector("#line-chart-gradient"), options);
chart.render(); //
// Missing Data
//
...
var chart = new ApexCharts(document.querySelector("#line-chart-missing"), options);
chart.render(); //
// Dashed line chart
//
...
var chart = new ApexCharts(document.querySelector("#line-chart-dashed"), options);
chart.render(); // 
// Stepline Charts
//
...
var chart = new ApexCharts(document.querySelector("#line-chart-stepline"), options);
chart.render(); //
// Realtime chart
//
