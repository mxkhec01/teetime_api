...
/*!********************************************!*\
  !*** ./resources/js/pages/demo.chartjs.js ***!
  \********************************************/
/**
...
!function ($) {
  ...
  ChartJs.prototype.initCharts = function () {
    ...
    if ($('#bar-chart-example').length > 0) {
      ...
      var colors = dataColors ? dataColors.split(",") : defaultColors.concat(); // create gradient
    ...
    if ($('#donut-chart-example').length > 0) {
      ...
      var colors = dataColors ? dataColors.split(",") : defaultColors.concat(); //donut chart
    ...
    if ($('#radar-chart-example').length > 0) {
      ...
      var radarChart = {
        ...
        datasets: [{
          label: "Desktops",
          backgroundColor: hexToRGB(colors[0], 0.2),
          borderColor: colors[0],
          ...
          label: "Tablets",
          backgroundColor: hexToRGB(colors[1], 0.2),
          borderColor: colors[1],
