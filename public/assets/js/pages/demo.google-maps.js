...
!function ($) {
  ...
  GoogleMap.prototype.init = function () {
    ...
    $(document).ready(function () {
      ...
      $this.createMarkers('#gmaps-markers'); //street view

      $this.createWithStreetview('#panorama', 40.7295174, -73.9986496); //types

      $this.createMapByType('#gmaps-types', -12.043333, -77.028333); // style - ultra light
